...
public class TerseRecordUnitTests
{
	...
	{
		RecordTerseExample product1 = new RecordTerseExample(1, "Tomato", 2.99m);
		RecordTerseExample product2 = new RecordTerseExample(1, "Tomato", 2.99m);
	...
	{
		RecordTerseExample product1 = new RecordTerseExample(1, "Tomato", 2.99m);
		RecordTerseExample product2 = product1 with { Price = 1.99m };
